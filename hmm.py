...
def handler(websocket):
    ...
    init_message = {
        'type': 'init',
        'name': 'AtwoodMachine',
        'default_settings': {'xAxisValue': 'time', 'yAxisValue': 'pos1'}
    }
...
# Function to update physics
def update_physics():
    global pos1, pos2, vel1, vel2, accel1, accel2, time_elapsed, stop_simulation
    ...
    while not stop_simulation:
        ...
        if pos1[1] >= 550 or pos2[1] >= 550:
            stop_simulation = True  # Stop the simulation when a block hits the boundary
        ...
        # Send data to WebSocket server if simulation is not stopped
...
def reset_simulation():
    ...
    all_data.clear()
    stop_simulation = False  # Reset the flag
