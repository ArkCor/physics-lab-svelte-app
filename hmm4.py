...
accel2 = 0.0
time_elapsed = 0.0
dt = .5  # simulation timestep

# Function to update physics
def update_physics():
    global pos1, pos2, vel1, vel2, accel1, accel2, time_elapsed, dt
...
button_end = Button(600, 450, 140, 30, 'End Sim', lambda: (pygame.quit(), stop.set(), server.ws_server.close(), server.ws_server.wait_closed()))
